...
var tipoProcessoDeleteBtns = document.querySelectorAll('.tipologia__deleteBtn');

if (tipoProcessoDeleteBtns && tipoProcessoDeleteBtns.length > 0) {
  tipoProcessoDeleteBtns.forEach(function (deleteBtn) {
    var tipologiaId = deleteBtn.dataset.tipologiaid;
    var tipologia = deleteBtn.dataset.tipologia;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _sweetalert.default.fire({
                  title: "".concat(tipologia),
                  html: '<p>Tem a certeza que deseja eliminar este tipo de processo?</p><br>' + '<p class="swal__alert">Esta acção é irreversível</p>' + '<p class="swal__alert--subtitle">Todos os processos deste tipo serão ELIMINADOS</p>',
                  icon: 'question',
              ...
              case 3:
                ...
                return (0, _axios.default)({
                  method: 'DELETE',
                  url: "/admin/deleteTipologia/".concat(tipologiaId)
                });
...
var deleteUserBtn = document.querySelectorAll('.utilizador__deleteBtn');

if (deleteUserBtn && deleteUserBtn.length > 0) {
  deleteUserBtn.forEach(function (delUserBtn) {
    var utilizadorId = delUserBtn.dataset.utilizadorid;
    var nome = delUserBtn.dataset.nome;
    delUserBtn.addEventListener('click', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                return (0, _axios.default)({
                  method: 'DELETE',
                  url: "/admin/deleteUtilizador/".concat(utilizadorId)
                });
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","admin.js"], null)