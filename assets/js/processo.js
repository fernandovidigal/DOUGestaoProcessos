...
},{}],"processo.js":[function(require,module,exports) {
"use strict";
...
var qlContent = document.getElementById('historicocontent');
...
if (qlEditor && qlContent && quill) {
  ...
  quill.on('text-change', function () {
    var content = qlEditor.innerHTML;
    qlContent.value = content;
  });
}

var deleteHistoricoBtns = document.querySelectorAll('.deleteHistoricoBtn');

if (deleteHistoricoBtns && deleteHistoricoBtns.length > 0) {
  deleteHistoricoBtns.forEach(function (deleteBtn) {
    var historicoId = deleteBtn.dataset.historico;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                return (0, _axios.default)({
                  method: 'DELETE',
                  url: "/processo/eliminarHistorico/".concat(historicoId)
                });
...
var processoOptionsWrapper = document.querySelector('.processo__options__wrapper');
var processoOptionsBtn = document.querySelector('.processooptions__btn');
var processoOptionsCLoseBtn = document.querySelector('.processo__options__closeBtn');

if (overlay && processoOptionsWrapper) {
  if (processoOptionsBtn) {
    processoOptionsBtn.addEventListener('click', function () {
  ...
  if (processoOptionsCLoseBtn) {
    processoOptionsCLoseBtn.addEventListener('click', function () {
      processoOptionsWrapper.classList.remove('processo__options__wrapper--open');
      overlay.classList.remove('overlay--open');
    });
  }
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","processo.js"], null)