...
if (dialogMessage) {
  ...
  _sweetalert.default.fire(dialogParams);
}

var naoaplicavel = document.querySelector('.naoaplicavel');
var referenciaInput = document.querySelector('.referencia__input');
...
var tableRows = document.querySelectorAll('.table_data_row');

if (tableRows && tableRows.length > 0) {
  tableRows.forEach(function (row) {
    var processoId = row.dataset.processo;
...
var processoDeleteBtnList = document.querySelectorAll('.processo-deleteBtn');

if (processoDeleteBtnList && processoDeleteBtnList.length > 0) {
  processoDeleteBtnList.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
        var processoId, referencia, designacao, result, response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                e.stopPropagation();
                processoId = this.dataset.processo;
                referencia = this.dataset.referencia;
                designacao = this.dataset.designacao;
                _context.next = 7;
                return _sweetalert.default.fire({
                  title: "".concat(designacao),
              ...
              case 7:
                ...
                return (0, _axios.default)({
                  method: 'DELETE',
                  url: "/eliminarProcesso/".concat(processoId)
                });
...
},{"sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
